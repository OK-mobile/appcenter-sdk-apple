Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://github.com/OK-mobile/appcenter-sdk-apple/releases/download/#{s.version}/AppCenter-SDK-Apple-#{s.version}.zip" }
 ...
 s.subspec 'Distribute' do |ss|
    ...
    ss.ios.vendored_frameworks = "AppCenter-SDK-Apple/AppCenterDistribute.framework"
 end

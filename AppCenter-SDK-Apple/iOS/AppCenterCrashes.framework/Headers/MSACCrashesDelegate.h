...
@optional
- (BOOL)crashes:(MSACCrashes *)crashes shouldProcessOKTTAssertReport:(MSACErrorReport *)errorReport;
- (void)crashes:(MSACCrashes *)crashes willSendOKTTAssertReport:(MSACErrorReport *)errorReport;
- (void)crashes:(MSACCrashes *)crashes didSucceedSendingOKTTAssertReport:(MSACErrorReport *)errorReport;
- (void)crashes:(MSACCrashes *)crashes didFailSendingOKTTAssertReport:(MSACErrorReport *)errorReport withError:(nullable NSError *)error;
- (NSArray<MSACErrorAttachmentLog *> *)attachmentsWithCrashes:(MSACCrashes *)crashes forOKTTAssertReport:(MSACErrorReport *)errorReport;
